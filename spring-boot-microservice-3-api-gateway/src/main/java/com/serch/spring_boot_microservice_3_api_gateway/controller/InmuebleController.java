...
import com.serch.spring_boot_microservice_3_api_gateway.request.InmuebleServiceRequest;
...
public class InmuebleController {
    ...
    public ResponseEntity<?> saveInmueble(@RequestBody Object inmueble){
        return new ResponseEntity<>(inmuebleServiceRequest.saveInmueble(inmueble),
                HttpStatus.CREATED
        );
    }

    @DeleteMapping("{inmuebleId}")
    public ResponseEntity<?> deleteInmuble(@PathVariable("inmuebleId") Long inmuebleId){
